...
curl -LO https://raw.githubusercontent.com/CloudRik/monthly-games/refs/heads/main/Set-Up-Network-Load-Balancers/script.sh && sudo chmod +x script.sh && ./script.sh
